...
def grade_task1(action_text: str, email_id: str) -> float:
    ...
    Returns 1.0 for correct, 0.0 for wrong, 0.3 for valid but wrong category.
    """
    # Find the correct email data
...
def grade_task2(action_text: str, email_id: str) -> float:
    ...
    try:
        # Look for "priority=<number>" pattern
        import re
...
def grade_task3(action_text: str, email_id: str) -> float:
    ...
    # Check if reply exists and contains relevant keywords
